            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [
                    AppColors.primaryDarkTeal.withOpacity(0.8),
                    AppColors.primaryMintGreen.withOpacity(0.6),
                  ],
    ...
    final sections = [
      {
        ...
        'subtitle': 'Planificación de recursos y capacidades',
      ...
      },
      {
        ...
        'subtitle': 'Creación de nuevas órdenes de mantenimiento',
